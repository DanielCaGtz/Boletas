...
<html>
	<head>
		...
		<title>Boletas | <?= ucfirst($schoolName) ?></title>
		...
		<div class="wrapper">
			<header class="main-header">
				<a href="<?= base_url() ?>" class="logo">
					<span class="logo-mini"><b><?= ucfirst($schoolName) ?></b></span>
					<span class="logo-lg"><b>Boletas</b><?= ucfirst($schoolName) ?></span>
				</a>
						...
						<ul class="nav navbar-nav">
							<li class="dropdown user user-menu">
							  	<a href="#" class="dropdown-toggle" data-toggle="dropdown">
			  						<img src="<?= base_url(); ?>img/user.jpg" class="user-image" alt="User Image">
								...
								<ul class="dropdown-menu">
			  						...
			  						<li class="user-footer">
										<div class="pull-right"><a href="<?= base_url(); ?>signout" class="btn btn-default btn-flat">Cerrar sesión</a></div>
			  						</li>
								</ul>
		  					</li>
						</ul>
